...
bitonize: bitonize.o pgm.o
	g++ -O3 -o bitonize bitonize.o pgm.o

remove_background: remove_background.o pgm.o
	g++ -O3 -o remove_background remove_background.o pgm.o

decrease_colors_count: decrease_colors_count.o pgm.o
	g++ -O3 -o decrease_colors_count decrease_colors_count.o pgm.o

bitonize_threshold: bitonize_threshold.o pgm.o
	g++ -O3 -o bitonize_threshold bitonize_threshold.o pgm.o

bitonize.o: bitonize.cpp types.h
	g++ -O3 -c -o bitonize.o bitonize.cpp

remove_background.o: remove_background.cpp types.h pgm.h
	g++ -O3 -c -o remove_background.o remove_background.cpp

decrease_colors_count.o: decrease_colors_count.cpp types.h pgm.h
	g++ -O3 -c -o decrease_colors_count.o decrease_colors_count.cpp

bitonize_threshold.o: bitonize_threshold.cpp types.h pgm.h
	g++ -O3 -c -o bitonize_threshold.o bitonize_threshold.cpp

pgm.o: pgm.cpp types.h
	g++ -O3 -c -o pgm.o pgm.cpp
